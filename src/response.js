...
function getGameConfig() {
    ...
    return '{"err":0,"errmsg":null,"data":{"queued": false, "banTime": 0, "hash": "BAN0", "lang": "en", "aid":' + constants.getActiveID() + ', "token": "token_' + constants.getActiveID() + '", "taxonomy": "341", "activeProfileId": "pmc' + constants.getActiveID() + '", "nickname": "user", "backend": {"Trading":"' + backendUrl + '", "Messaging":"' + backendUrl + '", "Main":"' + backendUrl + '", "RagFair":"' + backendUrl + '"}, "totalInGame": 0}}';
}
